...
// TODO: write your code below this line
function anagramFunc(par1, par2)
{
    let lenA = par1.length;
    let lenB= par2.length;
    
    if(lenA !== lenB){
       console.log('Invalid Input');
       return
    }
    let str1 = par1.split('').sort().join('');
    let str2 = par2.split('').sort().join('');
...
console.log(anagramFunc('iceman', 'cinema' ))
// TODO: write your code above this line
